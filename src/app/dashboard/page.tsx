...
import { Loader2, DollarSign, ShoppingCart, BarChart, Clock, CalendarIcon, LayoutDashboard, Coffee, UserPlus, History, Package, Warehouse, HardDrive } from 'lucide-react';
...
function renderPlaceholderTab(title: string, icon: React.ReactNode) {
    return (
    ...
    return (
        <div className="flex min-h-dvh flex-col bg-background">
            ...
            <main className="flex-1 overflow-y-auto p-4 md:p-6">
                 <Tabs defaultValue="analytics" className="mx-auto max-w-7xl">
                    ...
                    <TabsContent value="products">
                       {renderPlaceholderTab("Товары", <Package className="w-12 h-12 text-muted-foreground"/>)}
                    </TabsContent>
                    <TabsContent value="inventory">
                       {renderPlaceholderTab("Склад", <Warehouse className="w-12 h-12 text-muted-foreground"/>)}
                    </TabsContent>
                    <TabsContent value="devices">
                       {renderPlaceholderTab("Устройства", <HardDrive className="w-12 h-12 text-muted-foreground"/>)}
                    </TabsContent>
                </Tabs>
            </main>
        </div>
